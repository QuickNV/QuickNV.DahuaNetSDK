...
namespace Dahua.Api.Service
{
    public class ConfigService
    {
        ...
        public string GetDeviceSerialNumber()
        {
            ...
            DHClient.GetDeviceSerialNo(session.UserId, ref in_stuct, ref out_stuct, session.CommandTimeout);
        ...
        public string GetDeviceType()
        {
            ...
            DHClient.GetDeviceType(session.UserId, in_stuct, ref out_stuct, session.CommandTimeout);
        ...
        public string GetMachineName()
        {
            ...
            DHClient.GetMachineName(session.UserId, ref in_stuct, ref out_stuct, session.CommandTimeout);
        ...
        public int GetRtspPort()
        {
            ...
            DHClient.GetNewDevConfig(session.UserId, -1, SDK_NEWDEVCONFIG_CMD.CFG_CMD_RTSP, ref refObj, typeof(CFG_RTSP_INFO_OUT), session.CommandTimeout);
            return item.nPort;
        }
        ...
        public string GetSoftwareVersion()
        {
            ...
            DHClient.GetSoftwareVersion(session.UserId, in_stuct, ref out_stuct, session.CommandTimeout);
        ...
        public DateTime GetTime()
        {
            ...
            try
            {
                ...
                DHClient.GetDevConfig(session.UserId, EM_DEV_CFG_TYPE.TIMECFG, -1, ptrTimeCfg, (uint)nSize, ref dwReturn, session.CommandTimeout);
        ...
        public void SetTime(DateTime dateTime)
        {
            ...
            {
                Marshal.StructureToPtr(m_struTimeCfg, ptrTimeCfg, false);
                DHClient.SetDevConfig(session.UserId, EM_DEV_CFG_TYPE.TIMECFG, -1, ptrTimeCfg, (uint)nSize, session.CommandTimeout);
            }
            catch
            {
                throw;
