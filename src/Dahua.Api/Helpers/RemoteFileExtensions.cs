...
namespace Dahua.Api.Helpers
{
    ...
    public static class RemoteFileExtensions
    {
        ...
        /// <returns></returns>
        public static string ToVideoUserFriendlyString(this RemoteFile file)
        {
        ...
        /// <param name="file">The file.</param>
        /// <returns></returns>
        public static string ToPhotoFileNameString(this RemoteFile file)
        {
        ...
        /// <param name="file">The file.</param>
        /// <returns></returns>
        public static string ToDirectoryNameString(this RemoteFile file)
        {
